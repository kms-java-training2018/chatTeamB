	...
	<div id="header">
		...
		<div class="left">
			...
			<form action="/chat/main" method="POST">
				<button type="submit" name="action" value="toMainPage"
					class="button">メインページへ戻る</button>
			</form>
					...
					<c:if test="${judge}">
						<div class="userMessageArea">
							...
							<div class="userMessage">
								...
								<p1 hidden> <br>
								：会話番号： <c:out value="${list.messageNo}" /> <br>
								：会員番号： <c:out value="${list.userNo}" /> </p1>
							</div>
							<!-- 削除ボタン -->
